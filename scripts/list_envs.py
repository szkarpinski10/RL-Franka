...
importlib.import_module("rl_franka.tasks")
...
def main() -> None:
    ...
    parser.add_argument("--keyword", default="RlFranka-", help="Substring used to filter task ids.")
    ...
    table.title = "Available rl_franka Environments"
